...
<head>
    ...
    *:after
    ...
    <style>
        ...
        .toggle-theme-btn .dark-icon {
            display: none;
        }

        .toggle-theme-btn.dark .dark-icon {
            display: block;
        }

        .toggle-theme-btn.dark .light-icon {
            display: none;
        }
    </style>
</head>
...
<button id="toggleThemeBtn" class="toggle-theme-btn">
    <span class="icon light-icon">
        <iconify-icon icon="stash:sun-solid" width="28" height="28"  style="color: black"></iconify-icon>
    </span>
    <span class="icon dark-icon">
        <iconify-icon icon="stash:moon-solid" width="28" height="28"  style="color: white"></iconify-icon>
    </span>
</button>
